...
public class Event {
    ...
    public Event(Event joystickEvent) {
        this(
    ...
    public Event(String title, Instant timestamp, Type type, Boolean initial, String name, Long number, Long value) {
        this.title = title;
    ...
    public Event(JSTestEvent jsTestEvent) {
        this(
